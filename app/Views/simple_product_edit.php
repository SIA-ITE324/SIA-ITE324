...
<head>
    ...
    <title><?= $page_title ?? 'Edit Product' ?></title>
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-500 transition-colors">
                                    <div id="imagePreview" class="mb-4">
                                        <?php if ($product['images']): ?>
                                            <img src="<?= $product['images'] ?>" alt="Current product image" class="w-full h-48 object-cover rounded">
                            ...
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-medium"><?= date('M d, Y', strtotime($product['created_at'])) ?></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-gray-600">Last Updated:</span>
                                        <span class="font-medium"><?= date('M d, Y', strtotime($product['updated_at'])) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
